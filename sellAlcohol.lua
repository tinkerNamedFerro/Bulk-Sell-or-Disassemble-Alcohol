-- dofile "bin/x64/plugins/cyber_engine_tweaks/scripts/sellAlcohol.lua"

-- All alcohol sells for €$ 30, script counts and deletes all alcohol in backpack
-- then adds 30*counts eddies to inventory 
...
eddies = ItemID.new(TweakDBID.new("Items.money"))
result = ts:GiveItem(player, eddies, 30*TotalAlcohol)
if result then
    print("Obtained " .. tostring(5*TotalAlcohol) .. " Eddies")
else
    print("Failed to obtained " .. tostring(5*TotalAlcohol) .. " Eddies")
end
